...
//	@Bind(R.id.nine)ImageView nine;
	...
	ImageView one, two, three, four, five, six, seven, eight,nine, ten, eleven, empty, start;
	
	ArrayList<ImageView> buttonList = null;
	int[] arr = {R.drawable.one, R.drawable.img2, R.drawable.img3, 
			R.drawable.img4, R.drawable.img5, R.drawable.img6, 
			R.drawable.img7, R.drawable.img8,  R.drawable.img9,
			R.drawable.img10, R.drawable.img11, R.drawable.nine//empty
	...
	public void init(){
		...
		one = (ImageView) findViewById(R.id.oneLev2);
		one.setTag("00");
		two = (ImageView) findViewById(R.id.twoLev2);
		two.setTag("01");
		three = (ImageView) findViewById(R.id.threeLev2);
		three.setTag("02");
		four = (ImageView) findViewById(R.id.fourLev2);
		four.setTag("10");
		five = (ImageView) findViewById(R.id.fiveLev2);
		five.setTag("11");
		six = (ImageView) findViewById(R.id.sixLev2);
		six.setTag("12");
		seven = (ImageView) findViewById(R.id.sevenLev2);
		seven.setTag("20");
		eight = (ImageView) findViewById(R.id.eightLev2);
		eight.setTag("21");
		nine = (ImageView) findViewById(R.id.nineLev2);
		nine.setTag("22");
		ten = (ImageView) findViewById(R.id.tenLev2);
		ten.setTag("30");
		eleven = (ImageView) findViewById(R.id.elevenLev2);
		eleven.setTag("31");
		empty = (ImageView) findViewById(R.id.emptyLev2);
		empty.setTag("32");
		
		start = (ImageView) findViewById(R.id.startLev2);
...
//					}
					...
					checkNormal();
					if (c == 0) {
						startActivity(new Intent(getApplicationContext(), com.ahmed.level3.GameLevel3.class));
					}
					c = 0;
